...
const kesenians = [
  {
    ...
    asal: 'Bali',
    Jenis: 'Tarian',
    pict: 'https://awsimages.detik.net.id/community/media/visual/2020/08/25/tari-kecak-1_169.jpeg?w=1200',
    harga: 1200000,
    description: `Tarian Kecak yaitu salah satu satu tarian yang cukup populer di Pulau Bali. Tak hanya terkenal saja, tarian ini biasanya juga digunakan sebagai upacara penyambutan tamu, maupun upacara keagamaan.
  ...
  },
  {
    ...
    asal: 'Aceh',
    Jenis: 'Tarian',
    pict: 'https://static.cdntap.com/tap-assets-prod/wp-content/uploads/sites/24/2021/07/tari-1-1.jpg',
    harga: 1200000,
  ...
  },
  {
    ...
    pict: 'https://www.klikers.id/wp-content/uploads/2022/08/bermain-angklung.jpg',
    harga: 500000,
    description: `Angklung merupakan alat musik asal Indonesia yang terdiri atas 2 sampai 4 tabung bambu yang digantung dalam bingkai bambu pula. Ikatannya menggunakan tali rotan. Tabung ini dipangkas dan dipotong dengan hati-hati oleh pengrajin angklung ahli demi menghasilkan nada tertentu.
  ...
  },
  {
    ...
    asal: 'Jawa Tengah',
    Jenis: 'Teater',
    pict: 'https://upload.wikimedia.org/wikipedia/id/9/91/Reynan-tutup_lawang_sigotaka-palembang.jpg',
    harga: 1000000,
    description: `Wayang adalah salah satu contoh dari teater tradisional. Wayang sendiri sudah  dikenal sejak zaman prasejarah atau sekitar 1500 tahun sebelum Masehi. Masyarakat Indonesia sendiri pada saat itu memiliki kepercayaan animism berupa pemujaan dan tak jarang diwujudkan dalam bentuk arca atau gambar.
    Wayang sendiri adalah seni tradisional yang ada di indonesia yang banyak berkembang di Pulau Jawa dan Bali. Pertunjukan wayang juga sudah diakui oleh UNESCO sebagai karya kebudayaan yang mengagumkan dalam bidang cerita narasi dan warisan yang begitu indah serta berharga.
    Memahami wayang tak sampai disitu saja. Masih banyak hal menarik serta unik dari wayang yang bisa dipelajari. Wayang, dalang dan gamelan seperti suatu keterkaitan yang tak bisa lepas antara satu sama lain. Memahami akan pementasan wayang bisa lebih mudah dipahami dengan bacaan di buku Dhalang, Wayang dan Gamelan.`,
  },
  {
    name: 'Ketoprak',
    asal: 'Yogyakarta',
    Jenis: 'Teater',
    pict: 'https://asset.kompas.com/crops/82wdC77rsHiU4GJYrS_7_Zgln_8=/2x0:800x532/750x500/data/photo/2022/09/08/631969c54093a.jpg',
    harga: 750000,
    description: `Ketoprak adalah pertunjukan seni pentas drama tradisional yang diyakini berasal dari Surakarta dan berkembang pesat di Yogyakarta. Kesenian ini berasal dari permainan yang dilakukan oleh gadis-gadis desa ketika bulan purnama
  ...
  },
  {
    ...
    asal: 'Jawa Barat',
    Jenis: 'Teater',
    pict: 'https://bongkah.id/wp-content/uploads/2020/03/PW2_5732.jpg',
    harga: 700000,
    description: `Ludruk merupakan kesenian teater rakyat Jawa Timur yang berasal dari kalangan rakyat jelata. Di Surabaya ludruk masih kerap dipentaskan, bertahan meski hanya dimainkan oleh beberapa puluh orang.
